...
func NewMockStoreProvider() *StoreProvider {
...
func NewCustomMockStoreProvider(customStore storage.Store) *StoreProvider {
	return &StoreProvider{Custom: customStore}
}

// OpenStore opens and returns a store for given name space.
func (s *StoreProvider) OpenStore(name string) (storage.Store, error) {
...
func (s *StoreProvider) GetOpenStores() []storage.Store {
	panic("implement me")
}

// Close closes all stores created under this store provider.
func (s *StoreProvider) Close() error {
	return s.ErrClose
}
...
func (s *Store) getMatchingKeysAndDBEntries(tagName, tagValue string) ([]string, []DBEntry) {
