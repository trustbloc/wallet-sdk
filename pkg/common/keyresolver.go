...
// DRKeyResolver resolves DID in order to find public keys for VC verification using vdr.Registry.
...
type DRKeyResolver struct {
	resolver api.DIDResolver
}

// NewVDRKeyResolver creates DRKeyResolver.
func NewVDRKeyResolver(resolver api.DIDResolver) *DRKeyResolver {
	return &DRKeyResolver{resolver: resolver}
}

func (r *DRKeyResolver) resolvePublicKey(issuerDID, keyID string) (*verifier.PublicKey, error) {
...
func (r *DRKeyResolver) PublicKeyFetcher() verifiable.PublicKeyFetcher {
